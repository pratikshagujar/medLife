...
export class CartComponent {
  ...
  setCartItems(cartItems: any) {
    ...
    cartItems.forEach((el: any) => {
      ...
      productObj.productTotalPrice =
        Number(productObj.discountedPrice) * Number(productObj.quantity);
  ...
  calculateTotalPrice() {
    ...
    this.finalOrder.finalAmountToPay =
      this.finalOrder.totalAmount - this.finalOrder.totalDiscount;
  }
  ...
  changeQuantity(index: number, action: string) {
    ...
    productItem.productTotalPrice =
      Number(productItem.discountedPrice) * Number(productItem.quantity);
    this.calculateTotalPrice();
  }
